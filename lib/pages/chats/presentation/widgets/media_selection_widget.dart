            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  //     itemCount: imagePickerCubit.state.mediaList?.length ?? 0,
                  //     itemBuilder: (context, index) {
                  //       final media = imagePickerCubit.state.mediaList![index];
                  ...
                  //       onTap: () {
                  //         final mediaList =
                  //             imagePickerCubit.state.mediaList ?? [];
                  ...
                  //             ? MessageType.image
                  //             : mediaList.first.type == MediaType.video
                  //             ? MessageType.video
                  //             : MessageType.file;

                  //         Di().sl<MessageCubit>().sendMediaMessage(
                  //           mediaPath: imagePickerCubit.state.mediaList!
                  //               .map((e) => e.path)
                  //               .toList(),
                  //           type: mediaType,
                  //         );
